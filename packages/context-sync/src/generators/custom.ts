...
import type { ArchDecision, SnoutGuardConfig, ArchCategory } from '@snoutguard/core';
import {
  registerHelpers,
  groupByCategory,
  groupByStatus,
 ...
 * - config: the full SnoutGuardConfig
...
# Generated by SnoutGuard (https://github.com/rjc25/SnoutGuard) on {{generatedAt}}
